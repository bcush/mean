...
// A VIN is composed of 17 characters.
VehicleConstructor.prototype.genVIN = function() {
    this.vin = Math.floor((Math.random() * 100000000000000000) + 1);
}
...
// Create a Sedan
var Sedan = new VehicleConstructor("sedan", 4, 4, 45);
...
var Bus = new VehicleConstructor("bus", 4, 50, 35);
...
// Check to see if our random VIN method works.
Bus.genVIN();
console.log(Bus.vin);